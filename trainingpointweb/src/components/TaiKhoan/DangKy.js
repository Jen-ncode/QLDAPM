...
// import { useNavigate } from "react-router-dom";
// import sendEmail from "./send_mail";
// import './Styles.css'; // Đảm bảo tệp CSS được nhập vào
...
//     return (
//         <Container className="registration-background mt-5">
//             <Row className="justify-content-md-center">
//                 <Col md="6">
//                     <Card className="p-4 shadow-sm">
//                         <Card.Body>
...
//                                     <div className="position-absolute end-0 bottom-50 translate-middle-y">
//                                         <Form.Check
//                                             id="formConfirmPasswordShowPasswordCheckbox"
//                                             type="checkbox"
//                                             className="cursor-pointer"
//                                             label={<i className={`bi bi-eye${showPassword ? "-slash" : ""}`}></i>}
//                                             onChange={() => setShowPassword(!showPassword)}
...
//                                     <Button className="btn-lg mt-3" onClick={validateDangKy} disabled={loading}>
//                                         Đăng Ký
//                                     </Button>
//                                 </div>
...
//             <Modal show={showModal} onHide={handleClose}>
//                 <Modal.Header closeButton>
//                     <Modal.Title>Xác nhận OTP</Modal.Title>
//                 </Modal.Header>
//                 <Modal.Body>
//                     <p>Mã OTP đã được gửi đến email của bạn. Vui lòng nhập mã OTP để hoàn tất đăng ký.</p>
